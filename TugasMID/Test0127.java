...
public class Test0127 {
	...
	//	(c)setter  set nilai l = 5 dari konstruktor Balok()
		int l = 5;
	//	(d)setter ïƒ  set nilai p = 25 dari konstruktor Balok()
		int p = 25;
	//	(e)setter ïƒ  set nilai t = 10 dari konstruktor Balok(20,35, 15)
		int t = 10;
...
class Balok extends PersegiPanjang{
	...
	//(i) berisi nilai pada saat runtime pïƒŸ p, lïƒŸ=l dari konstruktor superclass persegi panjang tïƒŸ t;
		this.l = l;
		this.p = p;
		this.t = t;
	}
...
class PersegiPanjang{
	...
	//(n) berisi nilai pada saat runtime pïƒŸ p, lïƒŸ=l
		this.p = p;
		this.l = l;
	}
